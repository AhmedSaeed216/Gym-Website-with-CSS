      ...
      <div className="blur hero-blur"></div>
        <div className="left-h">
            ...
            <div className="hero-text">
              ...
              <div>
                <span >
                In here we will help you to shape and build your ideal body and lives up your life to fullest
...
{/* figures*/}
          ...
          <div className="figure">
            ...
            <div>
              <span>
                <NumberCounter end={50} preFix="+" start={35} delay="4"/>
              </span>
        ...
        <div className="right-h">
          ...
          className="heart_rate">
            <img src={Heart} alt="" />
            <span>Heart Rate</span><span>116</span>
          </motion.div>
